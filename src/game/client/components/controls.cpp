...
int CControls::SnapInput(int *pData)
{
	...
	// TClient: AI Speedrun Bot
	GameClient()->m_Bot.OnBeforeInput(&m_aInputData[g_Config.m_ClDummy]);

	// TClient: NEW TAS Pathfinding Bot
	GameClient()->m_TasBot.OnBeforeInput(&m_aInputData[g_Config.m_ClDummy]);

	// TClient: Avoiding Freeze - modify input before sending
	GameClient()->m_AvoidFreeze.OnBeforeInput(&m_aInputData[g_Config.m_ClDummy]);
