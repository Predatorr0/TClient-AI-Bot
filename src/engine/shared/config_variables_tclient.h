...
// Avoiding Freeze
MACRO_CONFIG_INT(TcAvoidFreeze, tc_avoid_freeze, 0, 0, 2, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Avoid freeze mode (0=off, 1=legit, 2=rage)")
MACRO_CONFIG_INT(TcAvoidFreezeAuto, tc_avoid_freeze_auto, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Auto-adjust lookahead ticks based on ping")
MACRO_CONFIG_INT(TcAvoidFreezeTicks, tc_avoid_freeze_ticks, 4, 2, 15, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Manual lookahead tick count when auto is off")
MACRO_CONFIG_INT(TcAvoidFreezeMargin, tc_avoid_freeze_margin, 4, 0, 16, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Safety margin in pixels from dangerous tiles")
MACRO_CONFIG_INT(TcAvoidFreezeDeath, tc_avoid_freeze_death, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Also avoid death tiles")
MACRO_CONFIG_INT(TcAvoidFreezeTele, tc_avoid_freeze_tele, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Also avoid unwanted teleport tiles")
MACRO_CONFIG_INT(TcAvoidFreezeLaser, tc_avoid_freeze_laser, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Also avoid freeze lasers and plasma")
MACRO_CONFIG_INT(TcAvoidFreezeSmartHook, tc_avoid_freeze_smart_hook, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Auto-hook to save from freeze when falling")
MACRO_CONFIG_INT(TcAvoidFreezeSmartJump, tc_avoid_freeze_smart_jump, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Auto-jump or block dangerous jumps to avoid freeze")

MACRO_CONFIG_INT(TcAvoidFreezeRadius, tc_avoid_freeze_radius, 12, 1, 28, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Effective hitbox radius for freeze detection (Greed Radius)")

// AI Speedrun Bot
MACRO_CONFIG_INT(TcBotEnabled, tc_bot_enabled, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable AI Speedrun Bot")
MACRO_CONFIG_INT(TcBotNavigation, tc_bot_navigation, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable Bot Pathfinding/Navigation")
MACRO_CONFIG_INT(TcBotStuckTicks, tc_bot_stuck_ticks, 50, 10, 500, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Ticks before bot considers itself stuck")
MACRO_CONFIG_INT(TcBotLogging, tc_bot_logging, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Log AI decision making and trigger events")
MACRO_CONFIG_INT(TcBotAutoReset, tc_bot_auto_reset, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Automatically kill character if stuck or dead to restart AI")
